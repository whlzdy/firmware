...
#define WG_SHELL_RESTART_VOICE_DAEMON "/opt/onecloud/script/watchdog/restart_voice_daemon.sh"
#define WG_SHELL_RESTART_GPS_DAEMON "/opt/onecloud/script/watchdog/restart_gps_daemon.sh"
#define WG_SHELL_RESTART_GPSUSB_DAEMON "/opt/onecloud/script/watchdog/restart_gpsusb_daemon.sh"
#define WG_SHELL_RESTART_LBS_DAEMON "/opt/onecloud/script/watchdog/restart_lbs_daemon.sh"
